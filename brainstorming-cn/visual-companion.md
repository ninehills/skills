...
- **UI 原型** — 线框图、布局、导航结构
- **用户流程图** — 用户旅程、交互路径、使用场景
- **并排视觉对比** — 对比两种布局、两种用户流程、两种交互方案
- **视觉细节** — 当问题涉及外观感受、间距、视觉层次
- **空间关系** — 用户流程图、功能关系图

**使用终端** 当内容是文字或表格的：

- **需求问题** — "X 是什么意思？"、"谁是目标用户？"、"哪些功能在范围内？"
- **概念性方案选择** — 在文字描述的需求方案之间做选择
- **权衡列表** — 优缺点、对比表
- **需求澄清** — 用户故事讨论、验收标准、成功指标
- **文本决策** — 任何回答是文字而非视觉偏好的问题
